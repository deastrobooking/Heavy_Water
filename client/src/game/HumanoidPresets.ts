...
export const HUMANOID_PRESETS: Record<string, HumanoidDefinition> = {
  ...
  HumanoidCaptainWarrior: {
    ...
    bodyType: "athletic",
    colors: {
      primary: new BABYLON.Color3(0.22, 0.28, 0.34),
      secondary: new BABYLON.Color3(0.62, 0.10, 0.08),
      skin: new BABYLON.Color3(0.62, 0.58, 0.54),
      hair: new BABYLON.Color3(0.95, 0.38, 0.12),
    },
    hasArmor: true,
    armorType: "captain",
    visualScale: HUMANOID_VISUAL_SCALE,
  ...
  HumanoidCaptainBerserker: {
    ...
    bodyType: "heavy",
    colors: {
      primary: new BABYLON.Color3(0.16, 0.10, 0.10),
      secondary: new BABYLON.Color3(0.78, 0.08, 0.04),
      skin: new BABYLON.Color3(0.48, 0.38, 0.34),
      hair: new BABYLON.Color3(1.00, 0.18, 0.06),
    },
    hasArmor: true,
    armorType: "captain",
    visualScale: HUMANOID_VISUAL_SCALE,
  ...
  HumanoidCaptainChampion: {
    ...
    bodyType: "heavy",
    colors: {
      primary: new BABYLON.Color3(0.12, 0.16, 0.22),
      secondary: new BABYLON.Color3(0.84, 0.66, 0.16),
      skin: new BABYLON.Color3(0.58, 0.56, 0.62),
      hair: new BABYLON.Color3(0.25, 0.86, 1.00),
    },
    hasArmor: true,
    armorType: "captain",
    visualScale: HUMANOID_VISUAL_SCALE,
