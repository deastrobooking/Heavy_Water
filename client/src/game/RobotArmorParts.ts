...
export const ARMOR_PART_REGISTRY: Record<ArmorSlot, ArmorPartDefinition[]> = {
  helmet: [...HELMET_PARTS, ...HELMET_PARTS_EXTRA, ...HUMANOID_HELMET_PARTS],
  chest: [...CHEST_PARTS, ...CHEST_PARTS_EXTRA, ...HUMANOID_CHEST_PARTS],
  back: [...BACK_PARTS, ...BACK_PARTS_EXTRA],
  leftShoulder: [...SHOULDER_PARTS, ...SHOULDER_PARTS_EXTRA, ...HUMANOID_SHOULDER_PARTS],
  rightShoulder: [...SHOULDER_PARTS, ...SHOULDER_PARTS_EXTRA, ...HUMANOID_SHOULDER_PARTS],
  ...
  legs: [...LEG_PARTS, ...LEG_PARTS_EXTRA, ...HUMANOID_LEG_PARTS],
};
